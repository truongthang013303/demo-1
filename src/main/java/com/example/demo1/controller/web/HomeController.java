...
public class HomeController 
{
			...
			@RequestParam(name = "limit", required = false) Optional<Integer> limit,@RequestParam(name="sort", required = false) String sort) 
	{
		...
		//mav.addObject("newest",listNews.get(0));		
	...
	public ModelAndView postSortByCate(@PathVariable(name = "code", required = false) String code, @RequestParam(name = "page", required = false) Optional<Integer> page, 
			@RequestParam(name = "limit", required = false) Optional<Integer> limit,@RequestParam(name="sort", required = false) String sort) 
	{
		ModelAndView mav = new ModelAndView("/web/home");
		NewDTO model = new NewDTO();
